...
from utils import calculate_tpr_fpr, plot_roc_curve
...
class Trainer(object):
    ...
    def train(self):
        ...
        for i in range(self.epochs):
            ...
            auroc, auprc, val_loss, tpr, fpr = self.test(dataloader="val")
            tprs.append(tpr)
            fprs.append(fpr)
            if self.experiment:
    ...
    def test(self, dataloader="test"):
        ...
        tpr, fpr = calculate_tpr_fpr(y_label, y_pred)
        ...
        if dataloader == "test":
            ...
            return auroc, auprc, test_loss, tpr, fpr
